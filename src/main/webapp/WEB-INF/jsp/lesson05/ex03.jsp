...
<body>
	...
	<fmt:formatNumber var="dollar" value="${number}" type="currency"
		currencySymbol="$" />
	달러 EL로 출력: ${dollar}

	<h1>Pattern</h1>
	3.14:
	<fmt:formatNumber value="3.14" />
	<br> 3.14(0.0000):
	...
	<fmt:formatDate var="pattern1" value="${today}"
		pattern="yyyy년 M월 dd일 HH:mm:ss" />
	<h3>pattern1: ${pattern1}</h3>
	<br>
	<fmt:formatDate var="pattern2" value="${today}"
		pattern="yyyy/MM/dd HH:mm:ss" />
	<h3>pattern2: ${pattern2}</h3>
